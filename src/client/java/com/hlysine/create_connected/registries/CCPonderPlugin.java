...
public class CCPonderPlugin implements PonderPlugin {
    ...
    public static void register(PonderSceneRegistrationHelper<Identifier> helper) {
        PonderSceneRegistrationHelper<ItemLike> SCENE_HELPER = helper.withKeyFunction(item -> RegisteredObjectsHelper.getKeyOrThrow(item.asItem()));
    ...
    public static void register(PonderTagRegistrationHelper<Identifier> helper) {
        PonderTagRegistrationHelper<ItemLike> TAG_HELPER = helper.withKeyFunction(item -> RegisteredObjectsHelper.getKeyOrThrow(item.asItem()));
