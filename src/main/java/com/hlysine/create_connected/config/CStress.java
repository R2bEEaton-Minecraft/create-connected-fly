...
public class CStress extends ConfigBase {
    ...
    private static final Map<Identifier, Double> DEFAULT_IMPACTS = new LinkedHashMap<>();
    private static final Map<Identifier, Double> DEFAULT_CAPACITIES = new LinkedHashMap<>();
